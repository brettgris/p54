...
function App() {
	...
	(0, _jquery2.default)(document).ready(function () {
		...
		_this.Post = new _Post2.default();
	});
};

exports.default = new App();

},{"./header/Header":3,"./post/Post":5,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
var _waypoints = require('../includes/waypoints');
 ...
 ***************/
	...
	_createClass(Header, [{
		key: 'activateWaypoint',
		value: function activateWaypoint() {
			var wp = document.getElementById('menu-waypoint');
			if (wp) {
  ...
  ***************/
		...
		key: 'handleWaypoint',
		value: function handleWaypoint(direction) {
			if (direction === "down") {
...
},{"../includes/waypoints":4}],4:[function(require,module,exports){
"use strict";
...
var Post = function Post() {
	...
	(0, _jquery2.default)('.products-slider').each(function () {
		var t = (0, _jquery2.default)(this);
		var s = new _Slider2.default({
			element: t,
			items: t.attr('show'),
			total: t.attr('total'),
...
},{"./Slider":6,"jquery":1}],6:[function(require,module,exports){
'use strict';
...
var Slider = function () {
	...
	_createClass(Slider, [{
		...
		value: function resize() {
			...
			var width = this.el.width() - this.next.width() - this.previous.width();
			this.content.width(width);
			var elWidth = (this.content.width() - this.options.spacing * (this.options.items - 1)) / this.options.items;
